...
* [How To Write a C# Analyzer and Code Fix](https://github.com/dotnet/roslyn/blob/master/docs/wiki/How-To-Write-a-C%23-Analyzer-and-Code-Fix.md) ⭐ 20,654 | 🐛 6,300 | 🌐 C# | 📅 2026-09-10 - The mother of all Roslyn tutorials :-) A realistic step-by-step introduction to syntax and semantic analysis as well as the syntax transformation.
* [C# Source Generators](https://github.com/amis92/csharp-source-generators) ⭐ 2,417 | 🐛 5 | 📅 2026-09-02 - Comprehensive list of additional learning sources, samples, and experimental and productive source generators. A perfect reference once you grasp the basics.
...
* [RoslynQuoter](https://github.com/KirillOsenkov/RoslynQuoter) ⭐ 1,105 | 🐛 13 | 🌐 C# | 📅 2025-05-31 - Online tool that for a given C# program generates syntax tree API calls that construct syntax tree of that program.
* [FlubuCore](https://github.com/dotnetcore/FlubuCore) ⭐ 936 | 🐛 31 | 🌐 C# | 📅 2026-03-25 - Cross platform build automation tool for building projects and executing deployment scripts using C# code.
...
* [StyleCop Analyzers for the .NET Compiler Platform](https://github.com/DotNetAnalyzers/StyleCopAnalyzers) ⭐ 2,852 | 🐛 456 | 🌐 C# | 📅 2025-12-31 - Port of StyleCop rules to Roslyn.
...
* [ErrorProne.NET](https://github.com/SergeyTeplyakov/ErrorProne.NET) ⭐ 1,129 | 🐛 97 | 🌐 C# | 📅 2026-09-08 - Set of analyzers and code fixes focusing on the correctness and performance of C# programs. Inspired with Google's [Error Prone](https://github.com/google/error-prone) ⭐ 7,236 | 🐛 526 | 🌐 Java | 📅 2026-09-10.
...
* [SonarC#](https://github.com/SonarSource/sonar-csharp) ⭐ 918 | 🐛 250 | 🌐 C# | 📅 2026-09-10 - Static code analyzer for C# language used as an extension for the SonarQube platform.
...
* [Svg to C# Source Generators](https://github.com/wieslawsoltes/SourceGenerators) ⚠️ Archived - SVG to C# compiler. Compiles SVG drawing markup to C# using [SkiaSharp](https://github.com/mono/SkiaSharp) ⭐ 5,569 | 🐛 882 | 🌐 C# | 📅 2026-09-10 as rendering engine.
