...
* [How To Write a C# Analyzer and Code Fix](https://github.com/dotnet/roslyn/blob/master/docs/wiki/How-To-Write-a-C%23-Analyzer-and-Code-Fix.md) ⭐ 20,636 | 🐛 6,302 | 🌐 C# | 📅 2026-09-01 - The mother of all Roslyn tutorials :-) A realistic step-by-step introduction to syntax and semantic analysis as well as the syntax transformation.
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,477 | 🐛 209 | 🌐 C# | 📅 2026-08-21 - Collection of 190+ analyzers and 190+ refactorings for C#. Covers coding style, code readability and simplification, removing redundancies, fixing compiler errors, and many more.
...
* [Code Cracker](https://github.com/code-cracker/code-cracker) ⭐ 1,146 | 🐛 145 | 🌐 C# | 📅 2024-02-13 - Analyzer library for C# and VB.NET. Offers diagnostics in many categories like performance, coding styles, as well as some basic refactorings.
...
* [SonarC#](https://github.com/SonarSource/sonar-csharp) ⭐ 917 | 🐛 249 | 🌐 C# | 📅 2026-09-01 - Static code analyzer for C# language used as an extension for the SonarQube platform.
...
* [Nullable.Extended](https://github.com/tom-englert/Nullable.Extended) ⭐ 61 | 🐛 0 | 🌐 C# | 📅 2025-04-30 - Roslyn tools and analyzers to improve the experience when coding with nullable reference types.
...
* [Svg to C# Source Generators](https://github.com/wieslawsoltes/SourceGenerators) ⚠️ Archived - SVG to C# compiler. Compiles SVG drawing markup to C# using [SkiaSharp](https://github.com/mono/SkiaSharp) ⭐ 5,563 | 🐛 864 | 🌐 C# | 📅 2026-09-01 as rendering engine.
