...
* [How To Write a C# Analyzer and Code Fix](https://github.com/dotnet/roslyn/blob/master/docs/wiki/How-To-Write-a-C%23-Analyzer-and-Code-Fix.md) ⭐ 20,681 | 🐛 6,674 | 🌐 C# | 📅 2026-09-21 - The mother of all Roslyn tutorials :-) A realistic step-by-step introduction to syntax and semantic analysis as well as the syntax transformation.
...
* [dotnet-script](https://github.com/filipw/dotnet-script) ⭐ 3,008 | 🐛 128 | 🌐 C# | 📅 2026-09-05 - Runs C# scripts from the .NET CLI, defines NuGet packages inline and edit/debugs them in VS Code.
...
* [ErrorProne.NET](https://github.com/SergeyTeplyakov/ErrorProne.NET) ⭐ 1,131 | 🐛 98 | 🌐 C# | 📅 2026-09-08 - Set of analyzers and code fixes focusing on the correctness and performance of C# programs. Inspired with Google's [Error Prone](https://github.com/google/error-prone) ⭐ 7,237 | 🐛 536 | 🌐 Java | 📅 2026-09-21.
...
* [SonarC#](https://github.com/SonarSource/sonar-csharp) ⭐ 919 | 🐛 250 | 🌐 C# | 📅 2026-09-19 - Static code analyzer for C# language used as an extension for the SonarQube platform.
...
* [Svg to C# Source Generators](https://github.com/wieslawsoltes/SourceGenerators) ⚠️ Archived - SVG to C# compiler. Compiles SVG drawing markup to C# using [SkiaSharp](https://github.com/mono/SkiaSharp) ⭐ 5,581 | 🐛 893 | 🌐 C# | 📅 2026-09-21 as rendering engine.
